...
Public Class Forgot_Pattern
    ...
    Private Sub Forgot_Pattern_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If TextBox1.Text = CaptchaString Then
            ...
            If IsExist Then
                ...
                Dim temp As String
                pattern = Decrypt(pattern).ToString
                Dim i As Integer = 0
                While i < pattern.Length
                    temp = pattern.Substring(i, 3)
                    If (temp = "111") Then
                        patstr = patstr + "," + "Red"
                    End If
                    If (temp = "222") Then
                        patstr = patstr + "," + "Yellow"
                    End If
                    If (temp = "333") Then
                        patstr = patstr + "," + "Green"
                    End If
                    ...
                    End If
                    If (temp = "555") Then
                        patstr = patstr + "," + "Orange"
                    End If
                    If (temp = "666") Then
                        patstr = patstr + "," + "purple"
                    End If
                    If (temp = "777") Then
                        patstr = patstr + "," + "Dark Green"
                    End If
                    If (temp = "888") Then
                        patstr = patstr + "," + "Indigo"
                    End If
                    If (temp = "999") Then
                        patstr = patstr + "," + "Turquoise"
                    End If
                    i = i + 3
                End While
                MessageBox.Show(patstr, "Pattern", MessageBoxButtons.OK, MessageBoxIcon.Information)
                TextBox1.Clear()
                GenerateCaptcha()
            Else
                MessageBox.Show("password Not Exist!!:(", "Pattern", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                TextBox1.Clear()
                GenerateCaptcha()
            End If
        Else
